...
class App(tkinter.Tk):
    def __init__(self):
        ...
        self.img = {
            ...
            "break" : tkinter.PhotoImage(file="coffee_break.png")
        }
    ...
    def build_canvas(self):
        ...
        self.canvas_image = self.canvas.create_image(500, 500, image=self.img["work"])
        self.canvas.pack()
        self.text = self.canvas.create_text(500,650,text="25:00",fill="Black",font=("Arial",35,"bold"))
    ...
    def build_labels(self):
        self.label1 = tkinter.Label(self,text="WORK TIME",fg="Green",bg="#fdd497",font=("Courier",35,"bold"),width=10)
        self.label1.place(x=370,y=25)

        self.label2 = tkinter.Label(self,fg="Green",bg="#fdd497",font=("Courier",20,"bold"))
        self.label2.place(x=450,y=900)
    ...
    def set_background(self,state):
        self.canvas.itemconfig(self.canvas_image,image=self.img[state])
